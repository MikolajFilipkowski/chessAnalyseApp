...
import AnalyseMenu from './analyseMenu/AnalyseMenu'
import PgnClass from './analyseMenu/classes/PgnClass'
...
function App() {
  ...
  const [board, setBoard] = useState(new BoardClass('rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2'))
  const [pgn, setPgn] = useState(new PgnClass(`
...
`))
  ...
  return (
    <>
      <Board board={board}/>
      <AnalyseMenu board={board} setBoard={setBoard}/>
    </>
  )
}
